...
```powershell
python Test\cases\Test2\script\main.py Test\cases\Test2\Testarticle.pdf `
  --workfolder Test\cases\Test2\review-work
```
...
python -m compileall -q Test\cases\Test2\script Test\cases\Test2\tests
```
...
详见 `Test/cases/Test2/reproduction/README.md`。快速运行：
