...
```powershell
pwsh -NoProfile -File .\PelicanRide\start-pelican.ps1
```
...
```powershell
pwsh -NoProfile -File .\PelicanRide\watch-pelican.ps1 `
  -RunName pelican-demo
```
...
```text
PelicanRide/runs/live-<RunName>.stdout.log
PelicanRide/runs/live-<RunName>.summary.log
PelicanRide/.clef-state/output-<RunName>-*/traces/*/workflow.jsonl
```
...
```text
PelicanRide/runs/output-<RunName>/0400_delivery/delivery-bundle/
